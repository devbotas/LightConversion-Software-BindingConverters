...
namespace LightConversion.Software.BindingConverters.QuickConverter.Tokens {
    public class NullCoalesceOperatorToken : TokenBase {
        ...
        public override Type ReturnType {
            get { return Condition.ReturnType == OnNull.ReturnType ? Condition.ReturnType : typeof(object); }
        }

        public override TokenBase[] Children {
            get { return new[] { Condition, OnNull }; }
        }
        ...
        internal override bool TryGetToken(ref string text, out TokenBase token, bool requireReturnValue = true) {
            ...
            if (!EquationTokenizer.TryEvaluateExpression(text.Substring(qPos + 2).Trim(), out right)) return false;
