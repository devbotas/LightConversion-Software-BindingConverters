            ...
            try {
                ...
                if (serviceProvider == null) getExpression = false;
                    ...
                    if (targetProvider != null && (targetProvider.TargetObject is Setter)) getExpression = false;
                        ...
                        if (propType == typeof(Binding)) return this;
                        getExpression = !propType.IsAssignableFrom(typeof(System.Windows.Data.MultiBinding));
                    }
                }

                P.Converter = new QuickConverter() { Convert = Convert, ConvertBack = ConvertBack, DynamicContext = DynamicContext, PType = PType, V0 = V0, V1 = V1, V2 = V2, V3 = V3, V4 = V4, V5 = V5, V6 = V6, V7 = V7, V8 = V8, V9 = V9 }.Get();
