...
namespace LightConversion.Software.BindingConverters.QuickConverter {
    public class QuickValue : MarkupExtension {
        ...
        public override object ProvideValue(IServiceProvider serviceProvider) {
            try {
                var converter = new QuickConverter(Value) { V0 = V0, V1 = V1, V2 = V2, V3 = V3, V4 = V4, V5 = V5, V6 = V6, V7 = V7, V8 = V8, V9 = V9, DynamicContext = DynamicContext };
                var value = (converter.ProvideValue(null) as IValueConverter).Convert(null, typeof(object), null, null);
                if (value is MarkupExtension) return (value as MarkupExtension).ProvideValue(serviceProvider);
                return value;
            } catch (Exception e) {
